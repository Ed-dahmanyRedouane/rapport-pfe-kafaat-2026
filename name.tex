...
\begin{figure}[H] % <--- [H] bach tb9a l'image nichan hna
    \centering
    \includegraphics[width=0.85\textwidth]{images/couverture-mondiale.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.70\textwidth]{images/equipe-scrum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.13\textwidth]{images/microsoft-teams.png}
...
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.6} % Tissa3 bin stoura b7al les abréviations
    \setlength{\arrayrulewidth}{1pt}
    \arrayrulecolor{primaryBlue}

    % Tableau b 4 colonnes m-9adin m3a l'wer9a
...
\vspace*{0.8cm} % <--- ZID HADI HNA BACH TB3ED "INTRODUCTION" 3LA L'KHAT ZRE9
Dans ce chapitre, nous détaillons la conception Microservices et la modélisation UML...
