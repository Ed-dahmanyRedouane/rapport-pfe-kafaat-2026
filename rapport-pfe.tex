...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/architecture-globale-app.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{images/architecture-backend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.20\textwidth]{images/docker-logo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.20\textwidth]{images/npm-logo.png}
    \caption{Logo de NPM}
    \label{fig:npm}
\end{figure}
